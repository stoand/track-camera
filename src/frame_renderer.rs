...
pub struct FrameRenderer<Rp: RenderPassAbstract> {
    ...
    framebuffers: Option<Vec<Arc<Framebuffer<Rp, ()>>>>,
}

impl<Rp: RenderPassAbstract> FrameRenderer<Rp> {
    pub fn new(width: usize, height: usize) -> Self {
        ...
        mod vs {
            ...
            #[ty = "vertex"]
            #[path = "src/shaders/frame_renderer.vert"]
            struct Dummy;
        }
        ...
        mod fs {
            #[derive(VulkanoShader)]
            #[ty = "fragment"]
            #[path = "src/shaders/frame_renderer.frag"]
            struct Dummy;
        }
    ...
    pub fn render_frame(&mut self, _img: Vec<u8>) {
